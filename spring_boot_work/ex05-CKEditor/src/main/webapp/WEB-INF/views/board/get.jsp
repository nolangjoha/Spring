            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                    	...
                    	<div> 
                    		${boardVO.content}
                    		<!-- out태그가 데이터에 태그가 존재하면, escape처리를 하여, HTML Entity로 변환해준다. &lt;는 '<', &gt;는'>'로 출력해준다.  -->
                    		<c:out value="${boardVO.content}" escapeXml="true"></c:out>
                    		<!--  이런 처리를 하는 이유는 escape기능을 지원해주기 때문, 간혹 게시판에 일부러 html코드를 써서 페이지 출력시 코드가 꼬여 제대로 안보이는 문제가 발생함. -->
                    	</div>
                    </div>
                    <div class="form-group">

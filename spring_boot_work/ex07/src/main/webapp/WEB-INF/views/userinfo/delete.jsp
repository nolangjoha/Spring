...
<main role="main" class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5 mb-4 text-center">회원탈퇴</h1>
    <div class="row">
            ...
            <form class="form-horizontal" id="deleteForm" action="/userinfo/delete" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="u_pwd" class="col-sm-6 col-form-label">현재 비밀번호</label>
                        <div class="col-sm-6">
                ...
                <div class="card-footer">   
                    <button type="button" class="btn btn-info btn-block" id="btnDelete">회원탈퇴</button>
                </div>

...
<main role="main" class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5 mb-4 text-center">내 정보</h1>
    <div class="row">
            ...
            <form class="form-horizontal" id="modifyForm" action="/userinfo/modify" method="post">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <label for="u_id" class="col-sm-2 col-form-label">가입일</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" id="sample2_postcode" name="u_zip_code" placeholder="우편번호" value="${userinfo.u_zip_code}">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="sample2_address" name="u_addr" placeholder="주소" value="${userinfo.u_addr}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="u_addrdetail" class="col-sm-2 col-form-label">세부주소</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="sample2_detailAddress" name="u_addrdetail" placeholder="세부 주소" value="${userinfo.u_addrdetail}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="u_phone" name="u_phone" placeholder="연락처" value="${userinfo.u_phone}">
                        </div>
                    </div>
                </div>

...
public class EmployeeVO {
	private Integer employee_id;  //primary key 컬럼명을 참조. int, long 기본데이터타입 사용하지 않고, Wrapper(여기서는Integer)클래스 사용 권장.
	private String	emp_name;	  // varchar는 String로 만든다.	 
	private String	email;   	  // 값자체가 소수점이 있으면 double로 만든다.
	private String	phone_number; // 날짜데이터는 Date, import해야함. 
